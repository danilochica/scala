...
object WorsheetMaps {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(59); 
  val numeros =List(4,8,11,15,16,25);System.out.println("""numeros  : List[Int] = """ + $show(numeros ));$skip(29); val res$0 = 
